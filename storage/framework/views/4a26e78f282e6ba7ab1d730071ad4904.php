            ...
            <div class="row d-flex">
                ...
                <div class="bg-white p-3 rounded shadow">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-4 " style="margin-left: 1000px;">
                        ...
                        <a href="<?php echo e(route('admin.mathecao.loaima_add')); ?>" class="btn btn-danger">Thêm Sản Phẩm </a>
                    ...
                    <table class="table table-bordered" id="Viettel" style="display:table;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('admin.mathecao.loaima_edit')); ?>" class="btn btn-dark">Sửa</a>
...
</html><?php /**PATH K:\doanbe2\doanbe2_ver3\Code_git\DoAnDoiTheCao\laravel_12\resources\views/admin/mathecao/loaima/mathecao_danhsach.blade.php ENDPATH**/ ?>