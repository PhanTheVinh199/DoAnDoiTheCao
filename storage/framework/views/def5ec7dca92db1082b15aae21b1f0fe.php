    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md">
        ...
        <div class="p-4">
            ...
            <div class="flex justify-end space-x-2">
                <a href="<?php echo e(route('admin.mathecao.loaima')); ?>" class="bg-gray-500 text-white px-4 py-2 rounded">Đóng</a>
                <button class="bg-red-700 text-white px-4 py-2 rounded">Cập nhật Sản Phẩm</button>
            </div>
        </div>
    </div>
</body>
</html><?php /**PATH K:\doanbe2\doanbe2_ver3\Code_git\DoAnDoiTheCao\laravel_12\resources\views/admin/mathecao/loaima/mathecao_danhsach_edit.blade.php ENDPATH**/ ?>