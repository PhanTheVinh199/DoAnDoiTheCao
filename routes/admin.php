...
Route::prefix('nganhang')->name('nganhang.')->group(function () {
    ...
    // Cài đặt ngân hàng
    Route::get('/caidat', [NganhangController::class, 'create'])->name('create');
    Route::post('/caidat', [NganhangController::class, 'store'])->name('store');
});
