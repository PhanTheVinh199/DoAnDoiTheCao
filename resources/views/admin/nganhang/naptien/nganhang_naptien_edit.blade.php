                ...
                <div class="modal-body">
                    <form action="{{ route('admin.naptien.approve', $napTien->id_lichsunap) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="so_tien_nap" value="{{ $napTien->so_tien_nap }}" class="form-control" disabled/>
                        </div>

                        <!-- Nội Dung -->
                        <div class="mb-3">
                            <label class="form-label">Nội Dung</label>
                            <textarea name="noi_dung" class="form-control" disabled>{{ $napTien->noi_dung }}</textarea>
                        </div>
