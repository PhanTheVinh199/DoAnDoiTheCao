            ...
            <div class="col-12">
                <div class="bg-white p-4 rounded shadow">
                    ...
                    <div class="mb-4 d-flex justify-content-between align-items-center">
                        <h1 class="h2 mb-0">Danh Sách Ngân Hàng Admin</h1>
                    </div>

                    <!-- Form Thêm Ngân Hàng Admin -->
                    <div class="mb-3">
        <a href="{{ route('admin.nganhang.admin.create') }}" class="btn btn-outline-primary">
            <i class="fas fa-user"></i> Cài Đặt Ngân Hàng User
        </a>
    </div>

                    <!-- Bảng danh sách ngân hàng admin -->
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center py-3">
                                            <i class="fas fa-database me-2"></i> Không có dữ liệu ngân hàng admin
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
