...
@section('title', 'Danh Sách Ngân Hàng Admin')
        ...
        <tbody>
            @forelse ($banks as $bank)
                <tr>
                    ...
                    <td>
                        <form action="{{ route('admin.nganhang.admin.delete', $bank->id_admin) }}" method="POST" onsubmit="return confirm('Bạn có chắc muốn xóa ngân hàng này?')">
                            @csrf
                            @method('DELETE')
