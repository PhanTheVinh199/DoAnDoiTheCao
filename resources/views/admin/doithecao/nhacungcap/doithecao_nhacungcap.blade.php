                        ...
                        @foreach ($nhacungcaps as $nhacungcap)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form
                                        action="{{ route('admin.doithecao.nhacungcap.delete', $nhacungcap->id_nhacungcap) }}"
                                        method="POST" class="d-inline"
                                        onsubmit="return confirm('Bạn có chắc chắn muốn xóa?');">
                                        @csrf
                                        @method('DELETE')
                                         <!-- Gửi kèm updated_at để kiểm tra concurrency -->
    <input type="hidden" name="updated_at" value="{{ $nhacungcap->updated_at?->toDateTimeString() }}">
