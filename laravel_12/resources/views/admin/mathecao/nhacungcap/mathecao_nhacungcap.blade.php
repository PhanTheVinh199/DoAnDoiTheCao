            ...
            <div class="row d-flex">
                ...
                <div class="bg-white p-3 rounded shadow">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-4" style="margin-left: 1000px;">
                        ...
                        <a href="{{ route('admin.mathecao.nhacungcap_add') }}" class="btn btn-primary">Thêm Nhà Cung Cấp</a>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.mathecao.nhacungcap_edit') }}" class="btn btn-dark">Sửa</a>
