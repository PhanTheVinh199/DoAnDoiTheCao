...
use App\Models\DoithecaoDanhsach; // THÊM dòng này
use App\Models\Thanhvien; // Nếu cần load danh sách thành viên
...
class DoithecaoDonhangController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $sanphams = DoithecaoDanhsach::all(); // Lấy danh sách sản phẩm
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'ma_don' => 'required|string|max:50|unique:doithecao_donhang,ma_don,' . $id . ',id_dondoithe',
